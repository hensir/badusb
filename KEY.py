...
# KeyInputdict是用来显示在TextEdit的按键字符串
KeyInputdict = {
    32: "KEY_SPACE",
    33: "key_Exclam",
    34: "key_QuoteDbl",
    ...
    16777248: "MOD_SHIFT_LEFT",
    16777249: "MOD_CONTROL_LEFT",
    16777250: "MOD_GUI_LEFT",
    16777251: "MOD_ALT_LEFT",
...
BUC1 = """//This DigiSpark script creates new local user and adds it to "Administrators" group
...
"""
BUC2 = """//This DigiSpark script opens up the powershell and makes your computer speak out a message.
#include "DigiKeyboard.h"
void setup() {
}
...
"""
BUC3 = """//This DigiSpark scripts downloads and executes a powershell script in hidden mode.
#include "DigiKeyboard.h"
void setup() {
}
...
"""
BUC4 = """//This script opens up a Windows command prompt and makes it open up another instance of itself and so on until the machine can take it no more and either locks or crashes. Credits to BlackBoot.
#include "DigiKeyboard.h"
void setup()
{
}
...
"""
# 存储BadUSB代码的一个列表 元素都是字符串变量 方便后期添加
BadUSBCodes = [BUC1, BUC2, BUC3, BUC4]

# dont need define 不需要define的按键
DNDefine = ["MOD_CONTROL_LEFT",
            "MOD_SHIFT_LEFT",
            "MOD_ALT_LEFT",
            "MOD_GUI_LEFT",
            "KEY_SPACE",
...
# 编辑框可接受 但未被头文件定义的按键常量 edit not define const
ENDConst = {
    "key_QuoteDbl": "34",
    "key_Apostrophe": "35",
    "key_Comma": "36",
